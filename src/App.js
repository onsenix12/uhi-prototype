...
function App() {
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      case 'alert':
        return <AlertScreen onNavigate={setCurrentScreen} />;
      case 'district':
        return <DistrictView onNavigate={setCurrentScreen} />;
      case 'building':
        return <Building3DView onNavigate={setCurrentScreen} />;
      case 'interventions':
        return (
          <InterventionOptions 
      ...
      case 'results':
        return <ResultsTracking onNavigate={setCurrentScreen} />;
      case 'preconstruction':
        return <PreConstructionTeaser onNavigate={setCurrentScreen} />;
      default:
        return renderHome();
    }
  };
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-gray-400 text-sm mt-1">
                {userBuilding.totalUnits} units • {userBuilding.towers} towers • Built {userBuilding.yearBuilt}
              </p>
            </div>
